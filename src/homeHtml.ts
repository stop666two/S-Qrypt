...
function clearMem(){notesTotal=0;if(appState.mk)appState.mk.fill(0);appState.mk=null;appState.opToken=null;appState.verificationToken=null;appState.notes=[];appState.displayedCount=0;appState.currentNoteId=null;appState.editingId=null;appState._keyCache={}}
// Auto-lock
...
// Audit
function renderAudit(){const body=document.getElementById('audit-body');setHTML(body,'<div class="audit-empty">暂无日志</div>')}
